...
1.	IC 7474	D flip-flop	1
2.	IC 7473	JK flip-flop	1
...
The storage elements (flip-flops) are devices capable of storing one-bit binary information. The binary info stored in the memory elements at any given time defines the state of the Sequential circuit. The input and the present state of the memory element determine the output. The next state of the storage elements is also a function of external inputs and the present state.
